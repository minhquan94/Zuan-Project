 ...
 */
public class SdHeaderInformation {
  ...
  @BoundNumber(size = "24", byteOrder = ByteOrder.BIG_ENDIAN)
	...
	public String toString() {
		...
		jsonBuilder.append('{').append("\"destinationDeviceId\":").append(this.destinationDeviceId).append(',')
				.append("\"reserved\":").append(this.reserved).append(',').append("\"dataLength\":")
				.append(this.dataLength).append(',').append("\"yearH\":").append(this.yearH).append(',')
				.append("\"yearL\":").append(this.yearL).append(',').append("\"monthH\":").append(this.monthH)
				.append(',').append("\"monthL\":").append(this.monthL).append(',').append("\"dayH\":").append(this.dayH)
				.append(',').append("\"dayL\":").append(this.dayL).append(',').append("\"hourH\":").append(this.hourH)
				.append(',').append("\"hourL\":").append(this.hourL).append(',').append("\"minuteH\":")
				.append(this.minuteH).append(',').append("\"minuteL\":").append(this.minuteL).append(',')
				.append("\"secondH\":").append(this.secondH).append(',').append("\"secondL\":").append(this.secondL)
				.append(',').append("\"milisecH\":").append(this.milisecH).append(',').append("\"milisecL\":")
				.append(this.milisecL).append(',').append("\"spareByte1\":").append(this.spareByte1).append(',')
				.append("\"sdNumber\":").append(this.sdNumber).append(',').append("\"networkUnitID1VehicleID12\":")
				.append(this.networkUnitID1VehicleID12).append(',').append("\"networkUnitID1VehicleID1\":")
				.append(this.networkUnitID1VehicleID1).append(',').append("\"networkUnitID0VehicleID12\":")
				.append(this.networkUnitID0VehicleID12).append(',').append("\"networkUnitID0VehicleID1\":")
				.append(this.networkUnitID0VehicleID1).append(',').append("\"networkUnitID3VehicleID12\":")
				.append(this.networkUnitID3VehicleID12).append(',').append("\"networkUnitID3VehicleID1\":")
				.append(this.networkUnitID3VehicleID1).append(',').append("\"networkUnitID2VehicleID12\":")
				.append(this.networkUnitID2VehicleID12).append(',').append("\"networkUnitID2VehicleID1\":")
				...
				.append(this.sequentialCounter).append(',').append("\"unitId\":").append(this.unitId).append('}');
	...
	public String getSdTime() {
		...
		time.append(year).append("-").append(month).append("-").append(day).append(" ").append(hour).append(":")
