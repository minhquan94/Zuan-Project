...
import com.zuan.depot.verticle.Verticle;
import com.zuan.depot.verticle.VerticleBase;
...
public class StartupListener {
  ...
  /** The depot config. */
  @Autowired
  private DepotConfiguration depotConfig;
  ...
  public void startVerticles() {
    ...
    verticles.forEach((k, v) -> {
      if (depotConfig.getVerticles().contains(k) && v instanceof VerticleBase) {
