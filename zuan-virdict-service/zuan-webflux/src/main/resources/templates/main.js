...
var LoginService = /** @class */ (function () {
    ...
    LoginService.prototype.login = function (userLogin) {
        ...
        return this.httpClient.post('http://localhost:8080/rest/login/admin', userLogin).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (user) {
    ...
    LoginService.prototype.logout = function () {
        localStorage.removeItem('currentUser');
        return this.httpClient.post('http://localhost:8080/rest/login/logout', null).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (user) {
            // login successful if there's a jwt token in the response
            if (user && user.token) {
                // store user details and jwt token in local storage to keep user logged in between page refreshes
                localStorage.setItem('currentUser', JSON.stringify(user));
