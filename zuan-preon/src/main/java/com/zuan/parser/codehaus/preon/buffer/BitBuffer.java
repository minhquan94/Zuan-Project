...
public interface BitBuffer {
  ...
  /**
   * Read specified number of bits (max 64) starting from the given bit position
   * in the big endian order, return the value as <b>long</b> (signed) and move
   * the bit pointer the given number of bits ahead. After reading the pointer
   ...
   * value as <b>long</b> (signed) and move the bit pointer the given number of
   * bits ahead. After reading the pointer will indicate the position of the
  ...
  /**
   * Read specified number of bits (max 64) starting from the given bit position
   * in either the little- or big-endian order, return the value as <b>long</b>
   * (signed) and move the bit pointer the given number of bits ahead. After
   * reading the pointer will indicate the position of the first bit that has
   * not been read yet.
   *
   ...
   * the big endian order, return the value as <b>boolean</b> and move the bit
   * pointer one bit ahead. After reading the pointer will indicate the position
   * of the first bit that has not been read yet.
   *
   ...
   * endian order, return the value as <b>boolean</b> and move the bit pointer
   * one bit ahead. After reading the pointer will indicate the position of the
   ...
   * little- or big-endian order, return the value as <b>boolean</b> and one bit
  ...
  /**
   * Read specified number of bits (max 8) starting from the current bit pointer
   * position in the big endian order, return the value as <b>byte</b> (signed)
   * and move the bit pointer the given number of bits ahead. After reading the
   * pointer will indicate the position of the position of the first bit that
  ...
  /**
   * Read specified number of bits (max 8) starting from the given bit position
   * in the big endian order, return the value as <b>byte</b> (signed) and move
   * the bit pointer the given number of bits ahead from its previous position
   * in the bit buffer. After reading the pointer will indicate the position of
  ...
  /**
   * Read specified number of bits (max 8) starting from the given bit position
   * in either the little- or big-endian order, return the value as <b>byte</b>
   * (signed) and move the bit pointer the given number of bits ahead. After
  ...
  /**
   * Read specified number of bits (max 16) starting from the given bit position
   * in the big endian order, return the value as <b>short</b> (signed) and move
   * the bit pointer the given number of bits ahead. After reading the pointer
   * will indicate the position of the first bit that has not been read yet.
   *
   * @param bitPos
   ...
   * Read specified number of bits (max 16) starting from the current bit
   * pointer position in either the little- or big-endian order, return the
   * value as <b>short</b> (signed) and move the bit pointer the given number of
   * bits ahead. After reading the pointer will indicate the first bit that has
   * not been read yet.
   *
   * @param nrBits
   *          number of bits to read
  ...
  /**
   * Read specified number of bits (max 16) stating from the given bit position
   * in either little- or big-endian order, return the value as <b>short</b>
   * (signed) and move the bit pointer the given number of bits ahead. After
   * reading the pointer will indicate the position of the first bit that has
   * not been read yet.
   *
  ...
  /**
   * Read specified number of bits (max 32) starting from the given bit position
   * in the big endian order, return the value as <b>int</b> (signed) and move
   * the bit pointer the given number of bits ahead. After reading the pointer
   * will indicate the position of the first bit that has not been read yet.
   *
   * @param bitPos
   ...
   * Read specified number of bits (max 32) starting from the current bit
   * pointer position in either the little- or big-endian order, return the
   * value as <b>int</b> (signed) and move the bit pointer the given number of
   * bits ahead. After reading the pointer will indicate the position of the
   * first bit that has not been read yet.
   *
   * @param nrBits
  ...
  /**
   * Read specified number of bits (max 32) stating from the given bit position
   * in either little- or big-endian order, return the value as <b>int</b>
   * (signed) and move the bit pointer the given number of bits ahead. After
   * reading the pointer will indicate the position of the first bit that has
   * not been read yet.
   *
   ...
   * in the big endian order, return the value as <b>long</b> (signed) and move
   * the bit pointer the given number of bits ahead. After reading the pointer
   * will indicate the position of the first bit that has not been read yet. The
   * bytes are read in the big-endian order.
   *
   * @param bitPos
   *          position of the first bit to read in the bit buffer
   * @param nrBits
  ...
  /**
   * Read specified number of bits (max 64) stating from the given bit position
   * in either little- or big-endian order, return the value as <b>long</b>
   * (signed) and move the bit pointer the given number of bits ahead. After
   * reading the pointer will indicate the first bit that has not been read yet.
   *
   * @param bitPos
  ...
  /**
   * Returns a new BitBuffer, starting at {@link #getBitPos()}, with the given
   * <code>length</code>. Moves the current position in this BitBuffer to
   * {@link #getBitPos()} <code> + length</code>. Note that each
   * {@link BitBuffer} is assumed to be completely independent of the other,
   * even though both are backed by the same data.
   *
   * @param length
   ...
   * @throws BitBufferUnderflowException
   *           If the number bytes addresses a position out of reach for this
   *           {@link BitBuffer}.
   */
  ByteBuffer readAsByteBuffer(int length) throws BitBufferUnderflowException;

  /**
   * Returns the contents of the underlying collection of bytes a
